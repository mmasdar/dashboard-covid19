...
from assets import patient_demographics, patient_med_readmit, baru
...
def render_content(tab):
    if tab == 'dem_tab'     :
        return patient_demographics.tab_3_layout
    elif tab == 'med_tab'   :
        return patient_med_readmit.tab_3_layout
    elif tab == 'data'      :
        return baru.tab_3_layout
